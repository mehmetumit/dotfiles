...
static const char brup[] = {"light -A 5; update-block 6;"};
//static const char brdown[] = {"xbacklight -dec 5; update-block 6;"};
static const char brdown[] = {"light -U 5; update-block 6;"};
...
static const char extracttext[] = {"extract-text" };
...
static const char sharesshot[] = {"mkdir -p $HOME/Screenshots && scrot -s --freeze $HOME/Screenshots/%Y-%m-%d@%H-%M-%S.png -e 'xclip -selection clipboard -target image/png -i $f'"};
...
//Used underscore for not conflict with other functions which can be exist in future
	// kbman no longer in use, started to use ibus instead
	...
	{MODKEY|ShiftMask,			XK_e,				spawn,		SHCMD(extracttext) },
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button4,        sigstatusbar,   {.i = 5} },
	{ ClkStatusText,        0,              Button5,        sigstatusbar,   {.i = 6} },
